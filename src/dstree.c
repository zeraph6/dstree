...
int main (int argc, char **argv)
{
    ...
    if (mode == 0)  //only build and store the index
    {
        ...
        /*dstree_index_settings @dstree_index.c :
         * dstree_index_setting : store setting of index(root_dir,ts_size,init_seg,max_leaf_size,buffered_memory_size,max_filname_size)
         * each leaf has a filename
         * */
